...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { end: @cohort.end, name: @cohort.name, start: @cohort.start } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { end: @cohort.end, name: @cohort.name, start: @cohort.start } }
